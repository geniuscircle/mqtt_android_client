...
public class ActionListener implements IMqttActionListener {
  ...
  private void publish() {
    ...
    NotificationHandler.toast(context, actionTaken, Toast.LENGTH_SHORT);
  }
  ...
  private void connect() {
    ...
    Connection c = ConnectionHandler.getInstance(context).getConnection(clientHandle);
    c.changeConnectionStatus(ConnectionStatus.CONNECTED);
  ...
  private void publish(Throwable exception) {
    ...
    String action = context.getString(R.string.toast_pub_failed,
        (Object[]) additionalArgs);
    c.addAction(action);
    NotificationHandler.toast(context, action, Toast.LENGTH_SHORT);
  ...
  private void connect(Throwable exception) {
    Connection c = ConnectionHandler.getInstance(context).getConnection(clientHandle);
    c.changeConnectionStatus(ConnectionStatus.ERROR);
