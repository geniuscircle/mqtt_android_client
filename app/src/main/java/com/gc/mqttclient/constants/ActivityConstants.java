package com.gc.mqttclient.constants;
...
public class ActivityConstants {
  ...
  /** Default message cb_publish_retain flag */
  ...
  /** Topic Bundle Key **/
  public static final String etxt_subscribe_topic = "etxt_subscribe_topic";
  /** History Bundle Key **/
  public static final String history = "history";
  /** Message Bundle Key **/
  public static final String message = "message";
  /** Retained Flag Bundle Key **/
  public static final String cb_publish_retain = "cb_publish_retain";
