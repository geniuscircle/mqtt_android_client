...
import com.gc.mqttclient.ui.fragments.HistoryFragment;
import com.gc.mqttclient.ui.fragments.PublishFragment;
import com.gc.mqttclient.ui.fragments.SubscribeFragment;
...
public class ConnectionDetailsActivity extends FragmentActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    connection = ConnectionHandler.getInstance(this).getConnection(clientHandle);
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    int menuID;
    Integer button = null;
    boolean connected = ConnectionHandler.getInstance(this)
    ...
    if (connected) {
      ...
      switch (selected) {
        case 0 : // history view
          menuID = R.menu.menu_activity_connection_details;
          break;
        case 1 : // subscribe view
          menuID = R.menu.menu_activity_subscribe;
          button = R.id.subscribe;
          break;
        case 2 : // publish view
          menuID = R.menu.menu_activity_publish;
          button = R.id.publish;
          break;
        default :
          menuID = R.menu.menu_activity_connection_details;
      ...
      switch (selected) {
        case 0 : // history view
          menuID = R.menu.menu_activity_connection_details_disconnected;
          break;
        case 1 : // subscribe view
          menuID = R.menu.menu_activity_subscribe_disconnected;
          button = R.id.subscribe;
          break;
        case 2 : // publish view
          menuID = R.menu.menu_activity_publish_disconnected;
          button = R.id.publish;
          break;
        default :
          menuID = R.menu.menu_activity_connection_details_disconnected;
    ...
    UIElementListener listener = new UIElementListener(this, clientHandle);
    // add listeners
    if (button != null) {
      // add listeners
      menu.findItem(button).setOnMenuItemClickListener(listener);
      if (!ConnectionHandler.getInstance(this).getConnection(clientHandle)
          .isConnected()) {
